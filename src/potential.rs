...
///
#[pyfunction]
pub fn rpot_val(q: f64, star: Star, spin: f64, earth: &Vec3, p: &Vec3, lam: f64) -> Result<f64, RocheError> {
...
///
#[pyfunction]
pub fn rpot_val_grad(q: f64, star: Star, spin: f64, earth: &Vec3, p: &Vec3, lam: f64) -> Result<(f64, f64, f64), RocheError> {
...
pub fn drpot(q: f64, p: &Vec3) -> Result<Vec3, RocheError> {
    ...
    Ok(Vec3::new(comp*p.x + mu1*(p.x - 1.) - p.x + mu,
...
pub fn drpot1(q: f64, spin: f64, p: &Vec3) -> Result<Vec3, RocheError> {
    ...
    Ok(Vec3::new(comp*p.x + mu1*(p.x - 1.) - ssq*p.x + mu,
...
pub fn drpot2(q: f64, spin: f64, p: &Vec3) -> Result<Vec3, RocheError> {
    ...
    let comp: f64 = (1. - mu)/r1/r1sq;
    let ssq: f64 = spin*spin;
    Ok(Vec3::new(comp*p.x + mu1*(p.x - 1.) - ssq*(p.x - 1.) + mu - 1.,
              comp*p.y + mu1*p.y - ssq*p.y,
              comp*p.z + mu1*p.z))
}
