...
use crate::{Star, Vec3};
use crate::{drpot1, drpot2, rpot1, rpot2};
use pyo3::prelude::*;
...
mod tests {
    ...
    fn face_test() -> Result<(), RocheError> {
        ...
        assert_eq!(
            pvec,
            Vec3::new(1.1352429036726859, 0.13524290367268593, 0.13524290367268593)
        );
        assert_eq!(
            dvec,
            Vec3::new(0.49134297246922065, 0.5917653290265037, 0.6390585878988438)
        );
